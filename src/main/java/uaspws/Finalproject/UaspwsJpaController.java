...
import uaspws.Finalproject.exceptions.NonexistentEntityException;
import uaspws.Finalproject.exceptions.PreexistingEntityException;
...
public class UaspwsJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("uaspws_Finalproject_jar_0.0.1-SNAPSHOTPU");
